      ...
      <div className="min-h-screen bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 md:mb-8">Appointment</h1>
            <button
              onClick={() => {
                setNewAppointment({ startTime: "", endTime: "", notes: "" });
                setShowCreateModal(true);
              }}
              className="px-2 py-1 md:px-4 md:py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700"
            >
              Create
            </button>
          ...
          <div className="bg-white rounded-lg md:shadow md:p-6">
            ...
            {/* Calendar View */}
            <div className="bg-white rounded-lg shadow md:p-4 p-2">
              {loading ? (
